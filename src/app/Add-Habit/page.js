...
export default function AddHabit(){
    ...
    return (
        ...
        <div  className="flex flex-col max-h-[376px]:h-2/10 max-w-[923px] max-sm:w-2/3 max-sm:h-2/6  justify-start items-center  space-y-3 bg-white border-1 border-black  w-2/8 h-2/10  rounded-lg">
                
                <span className="font-extrabold max-[376px]:mt-13 mt-20 text-black">Add {label}</span>
                ...
                <div className="flex flex-row space-x-40 max-sm:space-x-15">
